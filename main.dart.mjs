...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1320: (x0,x1) => x0.replaceChildren(x1),
      _1321: x0 => x0.click(),
      ...
      _1352: x0 => ({audio: x0}),
      _1353: (x0,x1) => x0.getUserMedia(x1),
      _1354: x0 => x0.getAudioTracks(),
      _1355: x0 => x0.stop(),
      _1356: x0 => ({video: x0}),
      _1357: x0 => x0.getVideoTracks(),
      ...
      _1361: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1370: Date.now,
      ...
      _1610: x0 => x0.close(),
      _1611: x0 => x0.trustedTypes,
      _1612: (x0,x1) => { x0.src = x1 },
      _1613: (x0,x1) => x0.createScriptURL(x1),
      _1614: x0 => x0.nonce,
      _1615: (x0,x1) => x0.debug(x1),
      _1616: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1616(f,arguments.length,x0) }),
      _1617: x0 => ({createScriptURL: x0}),
      _1618: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1619: (x0,x1) => x0.querySelectorAll(x1),
      _1620: () => new AbortController(),
      _1621: x0 => x0.abort(),
      _1622: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1623: (x0,x1) => globalThis.fetch(x0,x1),
      _1624: (x0,x1) => x0.get(x1),
      _1625: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1625(f,arguments.length,x0,x1,x2) }),
      _1626: (x0,x1) => x0.forEach(x1),
      _1627: x0 => x0.getReader(),
      _1628: x0 => x0.cancel(),
      _1629: x0 => x0.read(),
